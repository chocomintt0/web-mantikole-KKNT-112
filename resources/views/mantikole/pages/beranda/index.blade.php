...
@section('content')
    ...
    {{-- BAGIAN HERO --}}
    {{-- PENYESUAIAN: Padding vertikal dikurangi --}}
    ...
    <section class="bg-gradient-to-r from-white to-blue-50 py-16 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-8">
            {{-- PENYESUAIAN: Padding internal dan gap dikurangi di mobile --}}
            <div class="bg-white rounded-2xl shadow-2xl p-6 md:p-14 flex flex-col md:grid md:grid-cols-3 gap-8 md:gap-12 items-center border border-gray-100">
                ...
                <div class="text-center flex flex-col items-center">
                    {{-- PENYESUAIAN: Ukuran foto diperkecil di mobile --}}
                    <div class="relative w-48 h-48 md:w-64 md:h-64">
                        ...
                        <img src="{{ asset('images/kepala desa.png') }}" alt="Kepala Desa"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="group bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        ...
                        {{-- PENYESUAIAN: Tinggi gambar diperkecil di mobile --}}
                        <img src="{{ asset('images/air terjun.png') }}" alt="Berita 1" class="w-full h-48 md:h-56 object-cover transform transition-transform duration-500 group-hover:scale-110">
                    </div>
                    <div class="p-5 flex flex-col h-full">
                        <p class="text-sm text-gray-500 mb-2">12 September 2025</p>
                        <h3 class="text-xl font-bold text-gray-800 group-hover:text-blue-700 transition-colors duration-300">Gotong Royong Membersihkan Sungai Desa</h3>
                        <p class="text-gray-600 text-sm leading-relaxed my-4 flex-grow">Warga Desa Mantikole menunjukkan semangat kebersamaan dalam kegiatan gotong royong membersihkan area sungai untuk menjaga kebersihan dan kelestarian lingkungan.</p>
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-8">
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 md:p-14">
                ...
                {{-- PENYESUAIAN: Layout diubah menjadi 2 kolom di mobile --}}
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {{-- PENYESUAIAN: Tinggi kartu diperkecil lagi untuk mobile --}}
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 md:p-12 border border-gray-200">
                ...
                <div class="bg-gray-100 rounded-2xl p-2 md:p-3 shadow-inner">
                    <div class="rounded-xl overflow-hidden">
                        {{-- PENYESUAIAN: Tinggi peta diperkecil di mobile --}}
    ...
    <section class="bg-gray-50 py-14">
        <div class="max-w-5xl mx-auto px-4 sm:px-7">
            <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-14 relative">
                <h2 class="text-3xl sm:text-4xl font-bold text-blue-700 mb-10 text-center">Memories</h2>
                <div id="galleryModal" class="fixed inset-0 bg-black bg-opacity-80 z-50 hidden items-center justify-center p-4 opacity-0 transition-opacity duration-300">
                    <div class="relative bg-white rounded-xl shadow-2xl max-w-3xl w-full mx-auto overflow-hidden transform scale-75 opacity-0 transition-all duration-300 ease-out">
                        ...
                        <div class="flex flex-col md:flex-row">
                            ...
                            <div class="md:w-1/2 p-6 flex flex-col justify-center">
                                <h3 id="modalTitle" class="text-3xl font-bold text-blue-800 mb-3 leading-tight"></h3>
                                <p id="modalDescription" class="text-gray-700 text-base leading-relaxed"></p>
                                <div class="mt-6 text-sm text-gray-500">
                                    <p>Ditambahkan pada: <span id="modalDate">12/09/2025</span></p>
                ...
                <div id="galleryScroll" class="flex space-x-6 overflow-x-auto scroll-smooth [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                    <div class="gallery-item min-w-[300px] bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden flex-shrink-0 cursor-pointer" data-title="Kegiatan 1: Pemandangan Sungai" data-description="Ini adalah pemandangan indah dari sungai yang mengalir di Desa Mantikole, menjadi sumber kehidupan dan potensi wisata alam." data-img-src="{{ asset('images/air terjun.png') }}">
                        <img src="{{ asset('images/air terjun.png') }}" alt="kegiatan1" class="w-full h-52 object-cover pointer-events-none">
                        <div class="p-5 text-center pointer-events-none"><h3 class="font-semibold text-xl">Kegiatan 1</h3></div>
                    </div>
                    <div class="gallery-item min-w-[300px] bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden flex-shrink-0 cursor-pointer" data-title="Kegiatan 2: Gotong Royong" data-description="Warga desa bergotong royong membersihkan area sekitar sungai untuk menjaga kelestarian lingkungan." data-img-src="{{ asset('images/air terjun.png') }}">
                        <img src="{{ asset('images/air terjun.png') }}" alt="kegiatan2" class="w-full h-52 object-cover pointer-events-none">
                        <div class="p-5 text-center pointer-events-none"><h3 class="font-semibold text-xl">Kegiatan 2</h3></div>
                    </div>
                    <div class="gallery-item min-w-[300px] bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden flex-shrink-0 cursor-pointer" data-title="Kegiatan 3: Anak-Anak Bermain" data-description="Keceriaan anak-anak desa saat bermain di tepi sungai yang jernih dan asri." data-img-src="{{ asset('images/air terjun.png') }}">
                        <img src="{{ asset('images/air terjun.png') }}" alt="kegiatan3" class="w-full h-52 object-cover pointer-events-none">
                        <div class="p-5 text-center pointer-events-none"><h3 class="font-semibold text-xl">Kegiatan 3</h3></div>
                    </div>
                    <div class="gallery-item min-w-[300px] bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden flex-shrink-0 cursor-pointer" data-title="Kegiatan 4: Sunset di Desa" data-description="Pemandangan matahari terbenam yang memukau dilihat dari salah satu sudut Desa Mantikole." data-img-src="{{ asset('images/air terjun.png') }}">
                        <img src="{{ asset('images/air terjun.png') }}" alt="kegiatan4" class="w-full h-52 object-cover pointer-events-none">
                        <div class="p-5 text-center pointer-events-none"><h3 class="font-semibold text-xl">Kegiatan 4</h3></div>
                    </div>
                    <div class="gallery-item min-w-[300px] bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden flex-shrink-0 cursor-pointer" data-title="Kegiatan 5: Hasil Pertanian" data-description="Berbagai hasil pertanian unggulan dari Desa Mantikole yang siap dipasarkan." data-img-src="{{ asset('images/air terjun.png') }}">
                        <img src="{{ asset('images/air terjun.png') }}" alt="kegiatan5" class="w-full h-52 object-cover pointer-events-none">
                        <div class="p-5 text-center pointer-events-none"><h3 class="font-semibold text-xl">Kegiatan 5</h3></div>
                    </div>
                    <div class="gallery-item min-w-[300px] bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden flex-shrink-0 cursor-pointer" data-title="Kegiatan 6: Upacara Adat" data-description="Salah satu upacara adat yang masih dilestarikan oleh masyarakat Desa Mantikole hingga saat ini." data-img-src="{{ asset('images/air terjun.png') }}">
                        <img src="{{ asset('images/air terjun.png') }}" alt="kegiatan6" class="w-full h-52 object-cover pointer-events-none">
                        <div class="p-5 text-center pointer-events-none"><h3 class="font-semibold text-xl">Kegiatan 6</h3></div>
                    </div>
                </div>
    ...
    <script>
        ...
        const updateScrollButtons = () => {
            ...
            if (scrollRightBtn) {
                scrollRightBtn.style.opacity = scrollLeft + clientWidth >= scrollWidth - 1 ? '0' : '1';
                scrollRightBtn.style.pointerEvents = scrollLeft + clientWidth >= scrollWidth - 1 ? 'none' : 'auto';
            }
        };
        ...
        if (scrollContainer) {
            ...
            window.addEventListener('DOMContentLoaded', () => { startAutoScroll(); updateScrollButtons(); });
        ...
        function openModal(item) {
            if (!galleryModal || !modalImage || !modalTitle || !modalDescription) return;
        ...
        if (galleryItems.length > 0) {
            ...
            window.addEventListener('keydown', (event) => { if (event.key === 'Escape' && galleryModal && !galleryModal.classList.contains('hidden')) { closeModal(); } });
        }
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const animateCount = (counter) => {
                ...
                const step = (timestamp) => {
                    ...
                    counter.innerText = currentNumber.toLocaleString('id-ID');
