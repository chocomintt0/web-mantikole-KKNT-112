<div id="navbar-wrapper" class="fixed top-0 md:top-4 w-full z-50 transition-all duration-300 ease-in-out">
    <nav id="navbar" class="w-[95%] md:w-[900px] mx-auto z-50 py-2 px-4 sm:px-6 rounded-2xl md:rounded-[30px] shadow-lg transition-all duration-300 ease-in-out bg-blue-600 text-white">
        <div class="flex justify-between items-center h-12">
            ...
            <ul class="hidden md:flex gap-x-6 font-medium">
                <li><a href="{{ route('beranda.index') }}" class="relative nav-link {{ Request::routeIs('beranda.index') ? 'active-link' : '' }} hover:text-gray-200 transition-colors duration-200">Beranda</a></li>
                <li><a href="{{ route('profil-desa.index') }}" class="relative nav-link {{ Request::routeIs('profil-desa.index') ? 'active-link' : '' }} hover:text-gray-200 transition-colors duration-200">Profil Desa</a></li>
                <li><a href="{{ route('infografis.index') }}" class="relative nav-link {{ Request::routeIs('infografis.index') ? 'active-link' : '' }} hover:text-gray-200 transition-colors duration-200">Infografis</a></li>
                <li><a href="{{ route('layanan.index') }}" class="relative nav-link {{ Request::routeIs('layanan.index') ? 'active-link' : '' }} hover:text-gray-200 transition-colors duration-200">Layanan Publik</a></li>
            </ul>
        ...
        <div id="mobile-menu" class="md:hidden overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
            <ul class="flex flex-col pt-4 mt-2 border-t border-white/20 space-y-2">
                <li><a href="{{ route('beranda.index') }}" class="block py-2 px-3 rounded hover:bg-blue-800 {{ Request::routeIs('beranda.index') ? 'active-mobile-link' : '' }}">Beranda</a></li>
                <li><a href="{{ route('profil-desa.index') }}" class="block py-2 px-3 rounded hover:bg-blue-800 {{ Request::routeIs('profil-desa.index') ? 'active-mobile-link' : '' }}">Profil Desa</a></li>
                <li><a href="{{ route('infografis.index') }}" class="block py-2 px-3 rounded hover:bg-blue-800 {{ Request::routeIs('infografis.index') ? 'active-mobile-link' : '' }}">Infografis</a></li>
                <li><a href="{{ route('layanan.index') }}" class="block py-2 px-3 rounded hover:bg-blue-800 {{ Request::routeIs('layanan.index') ? 'active-mobile-link' : '' }}">Layanan Publik</a></li>
            </ul>
        </div>
    </nav>
</div>
